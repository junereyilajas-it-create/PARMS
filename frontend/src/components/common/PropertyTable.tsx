...
type Props = { rows: Property[]; onView?: (property: Property) => void; onMap?: (property: Property) => void; onEdit?: (property: Property) => void; onDelete?: (property: Property) => void }

export function PropertyTable({ rows, onView, onMap, onEdit, onDelete }: Props) {
