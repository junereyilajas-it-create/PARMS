  ...
  return (
    <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <button type="button" onClick={() => window.alert('Entity search is not yet implemented.')} className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition">
                    Alt+E
                  </button>
                </div>
              </div>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center mb-4">
              ...
              <label className="inline-block mt-4">
                <input
                  ...
                  accept=".pdf,.jpg,.png"
                />
                <button type="button" onClick={() => document.getElementById('file-upload')?.click()} className="px-6 py-2 bg-green-800 text-white rounded-lg hover:bg-green-900 transition cursor-pointer">
              ...
              <div className="space-y-2">
                {uploadedFiles.map((file, idx) => (
                  ...
                  >
                    ...
                    <button type="button" onClick={() => setUploadedFiles(uploadedFiles.filter(f => f !== file))} className="text-red-600 hover:text-red-800">×</button>
                  </div>
                ))}
              </div>
            )}
      ...
      <div className="flex gap-3 justify-center">
        <button type="button" onClick={() => window.alert('Transfer cancelled.')} className="px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition">
          Cancel
        </button>
        <button type="button" onClick={() => window.alert('Draft saved successfully.')} className="px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition">
          Previous Step
        </button>
        <button type="button" onClick={() => window.alert('Transfer finalized successfully!')} className="px-6 py-3 bg-green-700 text-white rounded-lg hover:bg-green-800 transition flex items-center gap-2">
          Save and Continue
          <span>→</span>
        </button>
      </div>
