    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex gap-2">
          ...
          <button className="flex items-center gap-2 px-4 py-3 bg-green-700 text-white rounded-lg hover:bg-green-800 transition">
      ...
      <div className="bg-green-50 border border-green-200 p-6 rounded-lg shadow flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <button className="px-6 py-2 bg-green-700 text-white rounded-lg hover:bg-green-800 transition flex items-center gap-2">
            <CheckCircle2 size={18} />
