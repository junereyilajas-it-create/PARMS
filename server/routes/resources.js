...
const config = {
  ...
  properties: { table: 'property_lots', idColumn: 'lot_id', columns: ['owner_id','address_id','property_type_id','classification_id','lot_number','title_number','location','lot_area','latitude','longitude','property_status'] },
  buildings: { table: 'property_buildings', idColumn: 'building_id', columns: ['lot_id','property_name','building_type','building_area','number_of_floors','construction_type','year_constructed','market_value','assessed_value','property_status'] },
